<%-- 
    Document   : CerrarReq
    Created on : 11-07-2020, 00:12:36
    Author     : Erick
--%>
                        ...
                        <fieldset>
                            ...
                            <div class="container" style="border-style: groove;">
                                ...
                                <div class="row row-5">
                                    ...
                                    <!-- /.col -->
                                    <div class="col">
                                        <button id="singlebutton" name="singlebutton" class="btn btn-danger">Cerrar</button>
                                    </div>
                                    <!-- /.col -->
                                </div>
                                <!-- /.row -->
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-9">
                                    <button id="singlebutton" name="singlebutton" class="btn btn-warning"><a href="IngresoReq.jsp" style="color: white;">Volver al Menú</a></button>
                                </div>
                            </div>
